...
export default function Tuning() {
  ...
  return (
    <div className="space-y-6">
      {/* Header mit Gradient */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-600/20 via-slate-800 to-cyan-600/20 border border-slate-700/50 p-6">
        <div className="absolute inset-0 bg-grid-white/5" />
        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-cyan-500/10 rounded-full blur-3xl" />
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-amber-500/20 rounded-2xl backdrop-blur-sm border border-amber-500/30 shadow-lg shadow-amber-500/20">
              <Car className="h-8 w-8 text-amber-400" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white">Tuning</h1>
              <p className="text-slate-400 mt-0.5">Tuning-Rechnungen einreichen</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card p-5 bg-gradient-to-br from-amber-900/30 to-slate-800/50 border-amber-700/30 hover:border-amber-600/50 transition-all group">
          <div className="flex items-center gap-4">
            <div className="p-4 bg-amber-600/20 rounded-2xl group-hover:scale-110 transition-transform">
              <Car className="h-8 w-8 text-amber-400" />
            </div>
        ...
        <div className="card p-5 bg-gradient-to-br from-green-900/30 to-slate-800/50 border-green-700/30 hover:border-green-600/50 transition-all group">
          <div className="flex items-center gap-4">
            <div className="p-4 bg-green-600/20 rounded-2xl group-hover:scale-110 transition-transform">
